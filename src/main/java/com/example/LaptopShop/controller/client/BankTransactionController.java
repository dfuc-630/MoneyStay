...
public class BankTransactionController {
    ...
    @GetMapping("/client/get-bank-transactions")
    public String getBankTransactions(Model model, RedirectAttributes redirectAttributes) {
        try {
            ...
            if (transactions == null || transactions.isEmpty()) {
                redirectAttributes.addFlashAttribute("error", "Không tìm thấy dữ liệu giao dịch.");
